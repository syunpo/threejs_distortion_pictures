...
const camera = new THREE.PerspectiveCamera(
  fov, //カメラの垂直視野
  canvasSize.w / canvasSize.h, //カメラのアスペクト比
  0.1,
  1000 //どこまで遠くを写すか
);
...
const createMesh = (img) => {
  ...
  const uniforms = {
     ...
     uImageAspect: { value: img.naturalWidth / img.naturalHeight }, // 画像のアスペクト
     uPlaneAspect: { value: img.clientWidth / img.clientHeight }, // プレーンのアスペクト
     uTime: { value: 0 },
   };
